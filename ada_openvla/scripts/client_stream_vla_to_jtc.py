...
class StreamVLAtoJTC(Node):
    ...
    def _ordered_seed_from_map(self, seed_positions):
        ...
        if seed_positions == [0.0]*len(self.args.arm_joints):
...
def main():
    ...
    ap.add_argument("--constraint_tol_rad", type=float, default=10.0, help="Joint constraint tolerance in radians (how close IK must stay to previous joint positions)")
